export default function PortfolioBox({
  ...
  return (
    <div className="bg-white p-6 m-8 border-b-4 border-blue-500 space-y-6 shadow-2xl rounded-md">
      ...
      <div>
        ...
        <h6 className="text-md font-extralight text-gray-400">{location}</h6>
      </div>
